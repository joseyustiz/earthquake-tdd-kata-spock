...
//        def usgsResponse20191013To20191013 = "{\n" + "    \"type\": \"FeatureCollection\",\n" + "    \"metadata\": {\n" + "        \"generated\": 1575318276000,\n" + "        \"url\": \"https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2019-10-13&endtime=2019-10-13\",\n" + "        \"title\": \"USGS Earthquakes\",\n" + "        \"status\": 200,\n" + "        \"api\": \"1.8.1\",\n" + "        \"count\": 0\n" + "    },\n" + "    \"features\": []\n" + "}"

//        def usgsResponse20191013To20191014 = "{\n" + "    \"type\": \"FeatureCollection\",\n" + "    \"metadata\": {\n" + "        \"generated\": 1575338478000,\n" + "        \"url\": \"https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2019-10-13&endtime=2019-10-14\",\n" + "        \"title\": \"USGS Earthquakes\",\n" + "        \"status\": 200,\n" + "        \"api\": \"1.8.1\",\n" + "        \"count\": 2\n" + "    },\n" + "    \"features\": [\n" + features20191013To20191014 + "," + features20191013To20191014_2 + "],\n" + "    \"bbox\": [\n" + "        -179.4758,\n" + "        -56.3302,\n" + "        -1.98,\n" + "        179.649,\n" + "        69.5739,\n" + "        631.66\n" + "    ]\n" + "}"
